 ...
 *
 * Copyright (C) 2016  Andrew A. Usenok
 *
...
module.exports = function(root, options) {
	...
	return function(req, res, next) {
		...
		// Restore from cache
		if (options.cache && cache[req.url]) {
